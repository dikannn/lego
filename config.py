...
# Тексты сообщений
WELCOME_MESSAGE = f"Здравствуйте! {HORSE_EMOJI} Добро пожаловать в Dragon Game!\nВыберите действие:"
...
ABOUT_BOT_MESSAGE = f"{INFO_EMOJI} Dragon Game — это лёгкий бот с мини-играми про банан! Найдите свой банан!"
